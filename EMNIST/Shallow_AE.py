...
class Shallow_AE(nn.Module):
    ...
    def __init__(self, n):
        super(Shallow_AE, self).__init__()
...
autoencoder = Shallow_AE(n).to(DEVICE)
optimizer = torch.optim.Adam(autoencoder.parameters(), lr = lr)
MSE = nn.MSELoss()  
    
def train(autoencoder, train_loader, history_W1, history_b1, history_W2, history_b2, history_trainloss, history_testloss):
...
def IP(history_W1, history_b1, history_W2, history_b2, history_trainloss, history_testloss):
    ...
    plt.title('Information Plane of Shallow Autoencoder', fontsize=15)
...
def main():
    ...
    for epoch in range(1,EPOCH+1):
        ...
        train(autoencoder, train_loader, history_W1, history_b1, history_W2, history_b2, history_trainloss, history_testloss)
